            ...
            <div className="sticky top-0 hidden lg:flex bg-neutral-300/50 backdrop-blur flex items-center h-20 justify-between px-10 shadow-md">
                ...
                <div className="flex gap-5">
                    ...
                    <div className="relative">
                        ...
                        <div className={`${getTotalItems === 0 ? 'hidden' : 'flex'} absolute bg-yellow text-blue h-5 p-1 w-5 bottom-5 rounded-full left-4 justify-center items-center font-semibold`}>{getTotalItems}</div>
                    </div>
                </div>
            </div>
